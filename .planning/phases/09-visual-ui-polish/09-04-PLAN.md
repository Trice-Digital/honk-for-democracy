...
Do NOT add animation in this plan — just the static paper cutout render. Wobble/animation is a future concern.
  </action>
  <verify>
...
**Do NOT modify** any other methods in IntersectionScene. Only change drawTrafficLights() and add 2-3 lines to the existing phaseChanged listener in create().
  </action>
  <verify>
